...
const Header = () => {
  ...
  const languageOptions = [
    { key: 'ko', text: t('language.ko', { defaultValue: 'Korean' }), value: 'ko' },
    { key: 'en', text: t('language.en', { defaultValue: 'English' }), value: 'en' },
    { key: 'zh', text: t('language.zh', { defaultValue: 'Chinese' }), value: 'zh' },
  ];
